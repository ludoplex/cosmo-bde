...
| `.cst` | opensmithgen | OpenSmith template source | 0/2 | ◐ Front-end parser + AST scaffold |
| `.csp` | opensmithgen | OpenSmith template project orchestration | 0/2 | ◐ Front-end parser + AST scaffold |
| `.csmap` | opensmithgen | OpenSmith mapping rules | 0/2 | ◐ Front-end parser + AST scaffold |
